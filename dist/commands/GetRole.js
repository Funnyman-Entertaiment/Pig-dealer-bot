...
exports.GetRole = new Command_1.Command("Get Role", "Gives you the role the bot pings when a pack drops or an announcement is made. It can be removed with `/removerole`.", true, false, new discord_js_1.SlashCommandBuilder()
    .setName("getrole")
