...
exports.RemoveRole = new Command_1.Command("Remove Role", "Removes the role the bot pings when a pack drops or an announcement is made from you.", false, false, new discord_js_1.SlashCommandBuilder()
    .setName("removerole")
