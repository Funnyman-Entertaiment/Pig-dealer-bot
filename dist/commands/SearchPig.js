...
exports.SearchPig = new Command_1.Command("SearchPig", "Searches for all the users in the current server that have an specified pig.", true, false, new discord_js_1.SlashCommandBuilder()
    .setName("searchpig")
